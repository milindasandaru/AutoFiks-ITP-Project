        ...
        <div className="bg-white rounded-2xl flex flex-col items-center justify-center text-center p-5 md:w-1/3">
          ...
          <div className="m-3 relative">
            <ul className="text-left text-gray-400 text-sm font-medium break-all">
              ...
              <li>Email</li>
              <p className="text-black text-base mb-3">SammuelCliffered@gmail.com</p>
              <li>Phone</li>
              <p className="text-black text-base mb-3">+94 76 766 7766</p>
              <li>Address</li>
              <p className="text-black text-base mb-3">Main Street, Horton Place, Wijerama</p>
              <li>Bio</li>
              <p className="text-black text-base mb-3">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nisi sed necessitatibus alias nesciunt esse
                deserunt veritatis rerum,veritatis reru, Nisi sed necessitatibus alias
                voluptas quisquam.
              </p>
            </ul>
          </div>
            ...
            <div className="flex mt-4 md:space-x-48 space-x-9">
              ...
              <div>
                <ul className="text-left text-sm space-y-3">
                  ...
                  <li className='flex items-center'><img src={greenLight} alt='status_light' className='w-2'/><span className='ml-2'>Approved</span></li>
                  <li className='flex items-center'><img src={greenLight} alt='status_light' className='w-2'/><span className='ml-2'>Approved</span></li>
                  <li className='flex items-center'><img src={greenLight} alt='status_light' className='w-2'/><span className='ml-2'>Approved</span></li>
                  <li className='flex items-center'><img src={redLight} alt='status_light' className='w-2'/><span className='ml-2'>Rejected</span></li>
                  <li className='flex items-center'><img src={redLight} alt='status_light' className='w-2'/><span className='ml-2'>Rejected</span></li>
                </ul>
              </div>
            </div>
